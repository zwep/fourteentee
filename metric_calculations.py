...
"""
The metric calculation done here is totally dependent on the file `store_kt_images`...
"""
...
for i_options in CALC_OPTIONS[0:1]:
    ...
    for sel_coil in COIL_NAME_ORDER:
        ...
        metric_dict = data_obj.get_result_container_Q(visual_obj.optimal_shim_rf_factor)
