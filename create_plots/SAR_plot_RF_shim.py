...
#
    ...
    for sel_coil in COIL_NAME_ORDER:
        ...
        sar_plot_list = htransf.get_all_mid_slices(sar_array[::-1], offset=MID_SLICE_OFFSET)
...
#
    ...
    fig_obj = hplot.ListPlot(plot_array_sar[None], subtitle=[COIL_NAME_ORDER_TRANSLATED],
